...
def cp_sat_transporter_explicit(output_dir):
    ...
    # 2. Muuttujat: jokaiselle (batch, stage)
    ...
    # 4. Asemien yksikäyttöisyys (AddNoOverlap)
    ...
    # 5. Transporterin siirrot ja yksikäyttöisyys
    ...
    result_path = os.path.join(logs_dir, "cp-sat-transporter-explicit-schedule.csv")
